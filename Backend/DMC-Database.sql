...
CREATE TABLE vehicle_inspection_form (
  ...
  rear_sensor_Rear_camera_remark VARCHAR(255),
...
DROP TABLE vehicle_inspection_form;


-- Vehicle Inspection Dedicated Table
CREATE TABLE vehicle_inspection_dedicated(
  id INT AUTO_INCREMENT PRIMARY KEY,
